<?php
/**
 * Implement a custom header for La Nave Nodriza
 *
 ...
 * @uses la_nave_nodriza_header_style() to style front-end.
 * @uses la_nave_nodriza_admin_header_style() to style wp-admin form.
 * @uses la_nave_nodriza_admin_header_image() to add custom markup to wp-admin form.
 ...
 * @return void
 */
function la_nave_nodriza_custom_header_setup() {
	$args = array(
		...
		'wp-head-callback'       => 'la_nave_nodriza_header_style',
		'admin-head-callback'    => 'la_nave_nodriza_admin_header_style',
		'admin-preview-callback' => 'la_nave_nodriza_admin_header_image',
	);
...
add_action( 'after_setup_theme', 'la_nave_nodriza_custom_header_setup', 11 );
 ...
 * @return void
 */
function la_nave_nodriza_custom_header_fonts() {
...
add_action( 'admin_print_styles-appearance_page_custom-header', 'la_nave_nodriza_custom_header_fonts' );
 ...
 * @return void
 */
function la_nave_nodriza_header_style() {
 ...
 * @return void
 */
function la_nave_nodriza_admin_header_style() {
	$header_image = get_header_image();
?>
 ...
 * @return void
 */
function la_nave_nodriza_admin_header_image() {
	?>
